...
class _CartListState extends State<CartList> {
	...
	Future<List<MenuItemModel>> _loadInitialData() async {
		...
		userEmail = await PreferenceUtils.getUserEmail();
					...
					Navigator.pushReplacement(
							...
							MaterialPageRoute(
									builder: (BuildContext context) =>
											OrderPlacedSuccess(orderModel.orderNo.toString())));
				}, onError: (_onError) {
			setState(() {
				apiLoading = false;
			});
			...
			children: <Widget>[
				...
				Expanded(
					...
					child: Text(
						"\u20B9" + _getItemTotalPrice(),
						textAlign: TextAlign.center,
						style: TextStyle(fontSize: 18.ssp, color: Theme
								.of(context)
								.primaryColor),
					),
				)
