...
class _LunchState extends State<Lunch> with AutomaticKeepAliveClientMixin<Lunch> {
  ...
  void initState() {
    /*_menuItemList.add(MenuItemModel(
        ...
        description: "1 cup 250Grams rice with sambar",
        itemName: "Vegitable Rice",
        price: "30",
        itemCount: 0,
    ...
    _menuItemList.add(MenuItemModel(
        image:
            "https://i2.wp.com/www.vegrecipesofindia.com/wp-content/uploads/2015/05/arachuvitta-sambar-recipe-1.jpg",
        description: "200ml sambar ",
        itemName: "Sambar",
        price: "15",
        itemCount: 0,
        time: "12:30 PM - 3:00 PM"));*/
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        ...
                        style: TextStyle(fontSize: 13.ssp, color: Colors.teal),
                        maxLines: 2,
                      ),
                      Padding(
                        ...
                        child: Text(
                          _menuItemModel.time,
                          style: TextStyle(fontSize: 15.ssp, color: Colors.orange),
                          maxLines: 1,
                        ),
                      ),
                      Row(
